...
export default function NewsDetailPage({ newsItem, locale, newsId, pageMap, blockMap, detailPage }) {
  ...
  let entity = new NewsEntity(detailPage || newsItem, locale === "ja");
  ...
  // 画像は元のnewsItemから取得
  const originalEntity = new NewsEntity(newsItem, locale === "ja");
  let imageInfo = null;
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-12 bg-white rounded-xl shadow-sm p-6">
              <div className="flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
                <a
                  href={locale === 'ja' ? '/news' : '/en/news'}
                  className="inline-flex items-center px-6 py-3 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 transition-all duration-200 transform hover:scale-105 shadow-md hover:shadow-lg"
                >
