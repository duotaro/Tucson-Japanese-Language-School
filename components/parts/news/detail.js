...
export default function NewsDetail({ item }) {
  ...
  return (
    <div key={entity.id} className="max-w-full  shadow-md rounded-xl bg-slate-100">
        
        <div className="flex flex-cols mt-3p-5 bg-gray-100border-2 border-t-0 rounded-b-lg">
          <div className="relative w-52 md:w-60 hidden md:block">
            <Image loading="lazy" src={entity.image} width={200} height={100} style={{ objectFit: 'cover' }} className="object-cover object-center rounded-l-lg w-full h-full absolute inset-0" />
          </div>
          <div className="flex-1">
            <h2 className="text-md font-black sm:text-lg mt-4 px-4 text-center" style={{
            ...
            {entity.text && (
                <div className="line-clamp-2 px-8 min-h-8 mt-4 mb-4 text-md font-light leading-relaxed text-gray-500 ">
