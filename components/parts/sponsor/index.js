      ...
      <Section py="py-2 md:py-4 lg:py-8" bg={bg}>
        <div className="container px-6 mx-auto text-center" >
          <Link href={`/contact/donation/`}>
            <Title title={json.navigation.sponsors} fontSize="text-xl  sm:text-2xl lg:text-3xl"/>
          </Link>
          {/* {links?.length ? <Links links={links} /> : null} */}
        </div>
        <div className="container px-6 mx-auto">
          <div className="grid items-center justify-center gap-8 py-5 grid-cols-3 px-20">
            {sponsor.map((item) => {
                return (
